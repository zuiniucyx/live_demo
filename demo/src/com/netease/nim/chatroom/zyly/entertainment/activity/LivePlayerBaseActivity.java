...
import com.netease.nim.chatroom.zyly.entertainment.adapter.GiftAdapter;
...
import com.netease.nim.chatroom.zyly.entertainment.helper.GiftAnimation;
import com.netease.nim.chatroom.zyly.entertainment.module.ChatRoomMsgListPanel;
import com.netease.nim.chatroom.zyly.entertainment.module.ConnectedAttachment;
import com.netease.nim.chatroom.zyly.entertainment.module.DisconnectAttachment;
import com.netease.nim.chatroom.zyly.im.config.AuthPreferences;
import com.netease.nim.chatroom.zyly.im.session.actions.BaseAction;
        ...
        public void onEvent(List<ChatRoomMessage> messages) {
            ...
            for (ChatRoomMessage message : messages) {
               if (message != null && message.getAttachment() instanceof ChatRoomNotificationAttachment) {
                   ...
                   Log.e("cyx","attachment.getAccount()="+attachment.getAccount()+"----"+"roomInfo.getCreator()"+roomInfo.getCreator());
...
//        masterNameText.setText(roomInfo.getCreator());
        masterNameText.setText(AuthPreferences.getUserLoginName());
