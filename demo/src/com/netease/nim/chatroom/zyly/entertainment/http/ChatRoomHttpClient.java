package com.netease.nim.chatroom.zyly.entertainment.http;
...
import com.netease.nim.chatroom.zyly.base.http.NimHttpClient;
...
public class ChatRoomHttpClient {
     ...
     * 主播创建直播间
     */
//    public void masterEnterRoom(String account, String ext, boolean isVideoMode, final ChatRoomHttpCallback<EnterRoomParam> callback) {
...
//                .append(REQUEST_AVTYPE).append("=").append(isVideoMode ? KEY_VIDEO : KEY_AUDIO);
...
//                        enterRoomParam.setUrl(url);
//                        enterRoomParam.setExt(avType);
//                        // reply
