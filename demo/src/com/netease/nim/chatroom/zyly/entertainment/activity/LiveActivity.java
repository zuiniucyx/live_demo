...
import com.netease.nim.chatroom.zyly.entertainment.adapter.InteractionAdapter;
...
import com.netease.nim.chatroom.zyly.entertainment.model.InteractionMember;
...
import com.netease.nim.chatroom.zyly.im.util.file.AttachmentStore;
...
//        loadGift();
    ...
    public void onBackPressed() {
        Log.e("cyx","onBackPressed:isStartLive="+isStartLive);
        if (isStartLive) {
            logoutChatRoom();
        } else {
    ...
    protected void joinChannel(final LiveType liveType) {
        ...
        MicHelper.getInstance().joinChannel(avChatOptionalConfig, meetingName, liveType == LiveType.VIDEO_TYPE, new MicHelper.ChannelCallback() {
            ...
            public void onJoinChannelSuccess() {
                ...
                Log.e("cyx","onJoinChannelSuccess");
            }
...
//    }
    ...
    protected void updateUI() {
        ...
        masterNameText.setText(TextUtils.isEmpty(masterNick) ? AuthPreferences.getUserLoginName() : masterNick);
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.start_live_btn:
                    ...
                    break;
                case R.id.BackBtn:
                    Log.e("cyx","R.id.BackBtn:isStartLive="+isStartLive);
                    if (isStartLive) {
                        logoutChatRoom();
                    } else {
                        NIMClient.getService(ChatRoomService.class).exitChatRoom(roomId);
...
//    }
    ...
    public void onLivePermissionGranted() {
        ...
        Log.e("cyx","onLivePermissionGranted:isStartLive="+isStartLive);
        isStartLive = true;
